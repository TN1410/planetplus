...
<div class="responsive-menu res-hm" style="display: none;">
	...
	<?php $homeId = get_option('page_on_front');?>
		...
		<a href="<?php echo get_home_url() ?>" title="Planet Plus- Natural Energy"><img src="<?php echo CFS()->get('logo', $homeId); ?>" alt="Planet Plus- Natural Energy" /></a>
		<div id="nav-icon4">
			<span></span>
			<span></span>
			<span></span>
...
<header class="hom">
	<div class="wrapper">
		<div class="logo-div">
			<div class="logo"><a href="<?php echo get_home_url() ?>" title="Planet Plus- Natural Energy"><img src="<?php echo CFS()->get( 'logo', $homeId); ?>" alt="Planet Plus- Natural Energy" /></a></div>
			<div id="nav-icon4">
						<span></span>
						<span></span>
						<span></span>
